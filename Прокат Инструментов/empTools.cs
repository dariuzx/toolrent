...
{
    public partial class empTools : Form
    {
        public empTools()
        {
            InitializeComponent();
        ...
        private void empTools_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Hide();
            Form EmpMainForm = new EmpMainForm();
            EmpMainForm.Show();
        }

        private void empToolsDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
